...
<div class="container-fluid">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Input RPK Perubahan</li>
                        </ol>
                    </div>
                    <!--end col-->
    ...
    <div class="row">
                                ...
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-success"
                                                id="ctotal1">0</i></span> Kegiatan</p>
                                    </div>
                            ...
                            <table id="data_table1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="7">Anggaran BOK Perubahan</th>
        ...
        function status1() {
            $.ajax({
                type: "get",
                url: "<?php echo base_url('rpkperubahan/getbanner') ?>",
                dataType: "json",
        ...
        function status2() {
            $.ajax({
                type: "post",
                url: "<?php echo base_url('rpkperubahan/getbanner2') ?>",
                data: {
                    pkm: $('#pkm').val()
        ...
        function status3() {
            $.ajax({
                type: "post",
                url: "<?php echo base_url('rpkperubahan/getbanner3') ?>",
                data: {
                    pkm: $('#pkm').val(),
                    prog: $('#prog').val(),
                },
        ...
        $(function() {
            $('#data_table1').DataTable({
                ...
                "footerCallback": function(row, data, start, end, display) {
                    ...
                    $(api.column(6).footer()).html(numFormat(jumlah4));
                    $(api.column(8).footer()).html(numFormat(jumlah5));
                    $(api.column(10).footer()).html(numFormat(jumlah6));
                    $(api.column(12).footer()).html(numFormat(jumlah7));
                },
            });
        });
        ...
        function usulan(prog) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#judul").html("RPK Perubahan" + response.nama_program);
            ...
            $('#data_table3').DataTable({
                ...
                "footerCallback": function(row, data, start, end, display) {
                    ...
                    $(api.column(9).footer()).html(numFormat(jumlah1));
                    $(api.column(10).footer()).html(numFormat(jumlah2));
                    $(api.column(11).footer()).html(numFormat(jumlah3));
                },
            });
        ...
        // var dTable;
        // $(function() {
        //     dTable = $('#data_table3').DataTable({
        //         processing: true,
        //         serverSide: true,
        //         ajax: {
        //             type: 'get',
        //             url: '<?php echo base_url($controller . '/dt2') ?>'
        //         },
        //         columns: [{
        //                 data: 'id',
        //                 name: 'id',
        ...
        function belanja(ruk, menu) {
            ...
            $('#data_table_modal').DataTable({
                ...
                "ajax": {
                    "url": '<?php echo base_url('usulanrpkp/getAll') ?>',
                    "type": "POST",
                    "data": {
                        objek: $('#ruk').val(),
                        idPkm: $('#pkm').val(),
            ...
            $.validator.setDefaults({
                ...
                submitHandler: function(form) {
                    ...
                    if (distance1 > 0 && status !== 'Discuss') {
                        ...
                        $.ajax({
                            url: '<?php echo base_url('usulanrpkp/add') ?>',
                            type: 'post',
                            data: {
                                idPkm: idPkm,
                                idProgram: idProgram,
        ...
        function edit2(id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // $("#edit-form #idMenu").val(response.id_menu);
                    $("#edit2-form #status").val(response.status2);
                    $("#edit2-form #keterangan").val(response.keterangan);
                    $("#edit2-form #catatan").val(response.catatan2);
        ...
        function del(id) {
            ...
            if (distance1 > 0 && status !== 'Discuss') {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: '<?php echo base_url('usulanrpkp/remove') ?>',
                            type: 'post',
                            data: {
                                id: id
                            },
