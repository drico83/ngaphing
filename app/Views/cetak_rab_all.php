...
<body onload="window.print()">
    <div class="cetak">
        <h3 style="text-align: center;">RENCANA ANGGARAN BIAYA (RAB)</br>
            BANTUAN OPERASIONAL KESEHATAN PUSKESMAS </br>
            DANA ALOKASI KHUSUS NONFISIK BIDANG KESEHATAN TA <?= $tahun ?> </br>
