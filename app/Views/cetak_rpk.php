...
<body onload="window.print()">
    <div class="cetak">
        <h2 style="text-align: center;">RENCANA PELAKSANAAN KEGIATAN PUSKESMAS TAHUN ANGGARAN <?= $tahun ?></h2>
        <h3 style="text-align: center;">Nama Puskesmas : <?= strtoupper($puskesmas['pkm']) ?></h3>
        <?= $result; ?>
        ...
        <table style="border: none !important;">
            ...
            <tr style="border: none;">
                ...
                <td style="border: none;"></td>
                <td style="border: none;">Kepala Puskesmas <?= $puskesmas['pkm']; ?> </td>
            </tr>
            <tr style="border: none;">
                <td style="border: none;"></td>
                <td style="border: none;"></td>
