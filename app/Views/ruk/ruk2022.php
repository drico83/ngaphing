                ...
                <div class="row">
                    <div class="col">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Input RUK</li>
                        </ol>
                    </div>
                    <!--end col-->
                    ...
                    <div class="col-auto">
                        ...
                        <div class="avatar-box thumb-lg text-center me-2">
                            <span class="avatar-title bg-soft-purple rounded text-center" id="hari">12</span> <span style="font-size: 12px;">Hari</span>
                        </div>
                        <div class="avatar-box thumb-lg text-center me-2">
                            <span class="avatar-title bg-soft-pink rounded" id="jam">12</span> <span style="font-size: 12px;">Jam</span>
                        </div>
                        <div class="avatar-box thumb-lg text-center me-2">
                            <span class="avatar-title bg-soft-warning rounded" id="menit">12</span><span style="font-size: 12px;">Menit</span>
                        </div>
                        <div class="avatar-box thumb-lg text-center me-2">
                            <span class="avatar-title bg-soft-success rounded" id="detik">12</span><span style="font-size: 12px;">Detik</span>
                        </div>
                    </div>
                    <!--end col-->
                </div>
    ...
    <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-success" id="ctotal">0</i></span> Kegiatan</p>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-success" id="creject1"><i class="mdi mdi-trending-up"></i></span> Kegiatan</p>
                                    </div>
                                    <div class="col-auto align-self-center">
                                        <div class="report-main-icon bg-light-alt">
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-danger" id="cdiscuss1"><i class="mdi mdi-trending-down"></i></span> Kegiatan</p>
                                    </div>
                                    <div class="col-auto align-self-center">
                                        <div class="report-main-icon bg-light-alt">
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-success" id="capprove1"><i class="mdi mdi-trending-up"></i>10.5%</span> Kegiatan
                                        </p>
                                    </div>
                                    <div class="col-auto align-self-center">
                                        <div class="report-main-icon bg-light-alt">
            ...
            <div id="tabel2">
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-success" id="ctotal2">0</span> Kegiatan</p>
                                    </div>
                                    <div class="col-auto align-self-center">
                                        <div class="report-main-icon bg-light-alt">
                                            <i data-feather="users" class="align-self-center text-muted icon-sm"></i>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-success" id="creject2"><i class="mdi mdi-trending-up"></i></span> Kegiatan</p>
                                    </div>
                                    <div class="col-auto align-self-center">
                                        <div class="report-main-icon bg-light-alt">
                                            <i data-feather="clock" class="align-self-center text-muted icon-sm"></i>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-danger" id="cdiscuss2"><i class="mdi mdi-trending-down"></i></span> Kegiatan</p>
                                    </div>
                                    <div class="col-auto align-self-center">
                                        <div class="report-main-icon bg-light-alt">
                                            <i data-feather="activity" class="align-self-center text-muted icon-sm"></i>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-success" id="capprove2"><i class="mdi mdi-trending-up"></i>10.5%</span> Kegiatan
                                        </p>
                                    </div>
                                    <div class="col-auto align-self-center">
                                        <div class="report-main-icon bg-light-alt">
                ...
                <div class="main-card mb-3 card animated lightSpeedIn">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div>
                            <button class='btn btn-warning text-white' onclick="back1()" title='Back'><i class='fas fa-backward me-1'></i>Kembali</button>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="data_table2" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th rowspan="2">No.</th>
                                        <th rowspan="2">Nama Program Pelayanan</th>
                                        <th colspan="5">Anggaran BOK</th>
                                        <th rowspan="2" class="text-center">Aksi</th>
                                    </tr>
                                    <tr>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-success" id="ctotal3">0</i></span> Kegiatan</p>
                                    </div>
                                    <div class="col-auto align-self-center">
                                        <div class="report-main-icon bg-light-alt">
                                            <i data-feather="users" class="align-self-center text-muted icon-sm"></i>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-success" id="creject3"><i class="mdi mdi-trending-up"></i></span> Kegiatan</p>
                                    </div>
                                    <div class="col-auto align-self-center">
                                        <div class="report-main-icon bg-light-alt">
                                            <i data-feather="clock" class="align-self-center text-muted icon-sm"></i>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-danger" id="cdiscuss3"><i class="mdi mdi-trending-down"></i></span> Kegiatan</p>
                                    </div>
                                    <div class="col-auto align-self-center">
                                        <div class="report-main-icon bg-light-alt">
                                            <i data-feather="activity" class="align-self-center text-muted icon-sm"></i>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-success" id="capprove3"><i class="mdi mdi-trending-up"></i>10.5%</span> Kegiatan
                                        </p>
                                    </div>
                                    <div class="col-auto align-self-center">
                                        <div class="report-main-icon bg-light-alt">
                ...
                <div class="main-card mb-3 card animated lightSpeedIn">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="justify-content-end">
                            ...
                            <button class='btn btn-warning text-white' onclick="back2()" title='Kembali'><i class='fas fa-backward'></i>Kembali</button>
                        </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tambah Usulan Kegiatan</h5>
                        ...
                        <div class="modal-body">
                            <form id="add-form" class="pl-3 pr-3">
                                <div class="form-row">
                                    <input type="hidden" id="id" name="id" class="form-control" placeholder="No." maxlength="11" required>
                                </div>
                                ...
                                <div class="position-relative form-group row">
                                    <label for="tujuan" class="col-sm-2 col-form-label"> Tujuan: <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" id="tujuan" name="tujuan" class="form-control" placeholder="Tujuan" maxlength="255" required>
                                    </div>
                                </div>
                                <div class="position-relative form-group row">
                                    <label for="sasaran" class="col-sm-2 col-form-label"> Sasaran: <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" id="sasaran" name="sasaran" class="form-control" placeholder="Sasaran" maxlength="255" required>
                                    </div>
                                </div>
                                <div class="position-relative form-group row">
                                    <label for="target" class="col-sm-2 col-form-label"> Target Sasaran: <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" id="target" name="target" class="form-control" placeholder="Target Sasaran" maxlength="255" required>
                                    </div>
                                </div>

                                <div class="position-relative form-group row">
                                    <label for="tgjawab" class="col-sm-2 col-form-label"> Penanggungjawab: <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" id="tgjawab" name="tgjawab" class="form-control" placeholder="Penanggungjawab" maxlength="255" required>
                                    </div>
                                </div>

                                <div class="position-relative form-group row">
                                    <label for="sumberdaya" class="col-sm-2 col-form-label"> Kebutuhan Sumber Daya:
                                        <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" id="sumberdaya" name="sumberdaya" class="form-control" placeholder="Kebutuhan Sumber Daya" maxlength="255" required>
                                    </div>
                                </div>

                                <div class="position-relative form-group row">
                                    <label for="mitra" class="col-sm-2 col-form-label"> Mitra Kerja: <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" id="mitra" name="mitra" class="form-control" placeholder="Mitra Kerja" maxlength="255" required>
                                    </div>
                                </div>

                                <div class="position-relative form-group row">
                                    <label for="waktu" class="col-sm-2 col-form-label"> Waktu Pelaksanaan: <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" id="waktu" name="waktu" class="form-control" placeholder="Waktu Pelaksanaan" maxlength="255" required>
                                    </div>
                                </div>

                                <div class="position-relative form-group row">
                                    <label for="indikator" class="col-sm-2 col-form-label"> Indikator Kinerja: <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" id="indikator" name="indikator" class="form-control" placeholder="Indikator Kinerja" maxlength="255" required>
                                    </div>
                                </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <form id="edit2-form" class="pl-3 pr-3">
                                ...
                                <div class="position-relative form-group row">
                                    <label for="exampleEmail" class="col-sm-2 col-form-label">Kegiatan:</label>
                                    <div class="col-sm-10">
                                        <input type="text" id="keterangan" name="keterangan" class="form-control" placeholder="Keterangan" maxlength="255" disabled>
                                ...
                                <div class="position-relative form-group row">
                                    <label for="catatan" class="col-sm-2 col-form-label"> Catatan: <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="catatan" name="catatan" rows="3" placeholder="Tanggal : Catatan : Petugas : "></textarea>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="add-objek-form" class="pl-3 pr-3">
                                ...
                                <input type="hidden" id="id" name="id" class="form-control" placeholder="No." maxlength="11">
                                <div class="position-relative form-group row">
                                    <label for="idBelanja" class="col-sm-2 col-form-label"> Komponen Belanja: <span class="text-danger">*</span> </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="position-relative form-group row">
                                    <label for="harga" class="col-sm-2 col-form-label"> Harga : <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-4">
                                        <input type="text" id="harga" name="harga" class="form-control" placeholder="harga" maxlength="255" disabled>
                                    </div>
                                    <label for="satuan" class="col-sm-2 col-form-label"> Satuan : <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-4">
                                        <input type="text" id="satuan" name="satuan" class="form-control" placeholder="satuan" maxlength="255" disabled>
                                    </div>
                                </div>
                                <div class="position-relative form-group row">
                                    <label for="ket" class="col-sm-2 col-form-label"> Keterangan : <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" id="ket" name="ket" class="form-control" placeholder="keterangan" maxlength="255" required>
                                    </div>

                                </div>
                                <div class="position-relative form-group row">
                                    <label for="idBelanja" class="col-sm-2 col-form-label"> Koefisien (perkalian) <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">

                                        <input type="number" id="vol1" name="vol1" class="form-control" placeholder="Volume 1" maxlength="11" number="true" required>
                                    </div>
                                    <div class="col-sm-5">
                                ...
                                <div class="position-relative form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="number" id="vol2" name="vol2" class="form-control" placeholder="Volume 2" maxlength="11" number="true">
                                    </div>
                                    <div class="col-sm-5">
                                ...
                                <div class="position-relative form-group row">
                                    <label for="idBelanja" class="col-sm-2 col-form-label"></label>
                                    <div class="col-sm-5">
                                        <input type="number" id="vol3" name="vol3" class="form-control" placeholder="Volume 3" maxlength="11" number="true">
                                    </div>
                                    <div class="col-sm-5">
                                ...
                                <div class="position-relative form-group row">
                                    <label for="idBelanja" class="col-sm-2 col-form-label"></label>
                                    <div class="col-sm-5">
                                        <input type="number" id="vol4" name="vol4" class="form-control" placeholder="Volume 4" maxlength="11" number="true">
                                    </div>
                                    <div class="col-sm-5">
                                ...
                                <div class="position-relative form-group row">
                                    <label for="vol_total" class="col-sm-2 col-form-label"> Jumlah Volume : <span class="text-danger">*</span></label>
                                    <div class="col-sm-4">
                                        <input type="number" id="vol_total" name="vol_total" class="form-control" placeholder="Jumlah Volume" maxlength="11" number="true" disabled>
                                    </div>
                                    <label for="harga_total" class="col-sm-2 col-form-label"> Jumlah Harga : <span class="text-danger">*</span></label>
                                    <div class="col-sm-4">
                                        <input type="number" id="harga_total" name="harga_total" class="form-control" placeholder="Jumlah Harga" maxlength="11" number="true" disabled>
                                    </div>
                                </div>
                                <hr>
        ...
        <script>
            ...
            function status1() {
                $.ajax({
                    type: "get",
                    url: "<?php echo base_url('ruk/getbanner') ?>",
                    dataType: "json",
                    success: function(response) {
                        ...
                        $('#total1').html(response.data.disclaim1.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g,
                            "$1."));
                        $('#discuss1').html(response.data.discuss1.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g,
                            "$1."));
                        $('#approve1').html(response.data.approve1.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g,
                            "$1."));

                        $('#creject1').html(response.count.creject1);
                        $('#ctotal1').html(response.count.cdisclaim1);
                        $('#cdiscuss1').html(response.count.cdiscuss1);
                        $('#capprove1').html(response.count.capprove1);
                    }
                });
            };
            ...
            function status2() {
                $.ajax({
                    type: "post",
                    url: "<?php echo base_url('ruk/getbanner2') ?>",
                    data: {
                        pkm: $('#pkm').val()
                    ...
                    success: function(response) {
                        ...
                        $('#total2').html(response.data.disclaim2.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g,
                            "$1."));
                        $('#discuss2').html(response.data.discuss2.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g,
                            "$1."));
                        $('#approve2').html(response.data.approve2.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g,
                            "$1."));

                        $('#creject2').html(response.count.creject2);
                        $('#ctotal2').html(response.count.cdisclaim2);
                        $('#cdiscuss2').html(response.count.cdiscuss2);
                        $('#capprove2').html(response.count.capprove2);
            ...
            function status3() {
                $.ajax({
                    type: "post",
                    url: "<?php echo base_url('ruk/getbanner3') ?>",
                    data: {
                        pkm: $('#pkm').val(),
                        prog: $('#prog').val(),
                    },
                    ...
                    success: function(response) {
                        ...
                        $('#creject3').html(response.count.creject3);
                        $('#ctotal3').html(response.count.cdisclaim3);
                        $('#cdiscuss3').html(response.count.cdiscuss3);
                        $('#capprove3').html(response.count.capprove3);
            ...
            $(function() {
                ...
                $('#data_table1').DataTable({
                    ...
                    "footerCallback": function(row, data, start, end, display) {
                        ...
                        $(api.column(4).footer()).html(numFormat(jumlah2));
                        $(api.column(6).footer()).html(numFormat(jumlah3));
                    },
                });
            ...
            function subkom() {
                $.ajax({
                    ...
                    url: "<?php echo base_url('subkomponen/getsubkomponen2') ?>",
                    dataType: "json",
                    success: function(response) {
                        if (response.data) {
            ...
            function usulan(prog) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#judul").html("Rencana Usulan Kegiatan " + response.nama_program);
                ...
                $('#data_table3').DataTable({
                    ...
                    "footerCallback": function(row, data, start, end, display) {
                        ...
                        $(api.column(10).footer()).html(numFormat(jumlah));
                    },
                });
            ...
            function belanja(ruk, menu) {
                ...
                $('#data_table_modal').DataTable({
                    ...
                    "responsive": true,
                    "ajax": {
                        "url": '<?php echo base_url('usulan/getAll') ?>',
                        "type": "POST",
                        "data": {
                            objek: $('#ruk').val(),
                            idPkm: $('#pkm').val(),
                ...
                if (distance1 > 0 && status !== 'Discuss') {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $("#edit-form #mitra").val(response.mitra);
                            $("#edit-form #waktu").val(response.waktu);
                            $("#edit-form #indikator").val(response.indikator);
            ...
            function del(id) {
                ...
                if (distance1 > 0 && status !== 'Discuss') {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: '<?php echo base_url('usulan/remove') ?>',
                                type: 'post',
                                data: {
                                    id: id
                                },
