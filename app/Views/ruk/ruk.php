                            ...
                            <table id="data_table1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center">Nama UPT</th>
                                        <th rowspan="2" class="text-center">BLUD</th>
                                        <th colspan="4" class="text-center">Anggaran BOK</th>
                            ...
                            <form id="add-form" class="pl-3 pr-3">
                                ...
                                <div class="position-relative form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        Keterangan Menu : &nbsp; <span class="badge bg-info">Wajib</span>
                                ...
                                <div class="position-relative form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="sumberdaya" name="sumberdaya" class="form-control"
                                            placeholder="Kebutuhan Sumber Daya" maxlength="255" required>
                                    </div>
                                </div>

                                <div class="position-relative form-group row">
                                    <label for="mitra" class="col-sm-2 col-form-label"> Mitra Kerja: <span
                                            class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" id="mitra" name="mitra" class="form-control"
                                            placeholder="Mitra Kerja" maxlength="255" required>
                                    </div>
                                </div>

                                <div class="position-relative form-group row">
                                    <label for="waktu" class="col-sm-2 col-form-label"> Waktu Pelaksanaan: <span
                                            class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" id="waktu" name="waktu" class="form-control"
                                            placeholder="Waktu Pelaksanaan" maxlength="255" required>
                                    </div>
                                </div>

                                <div class="position-relative form-group row">
                                    <label for="indikator" class="col-sm-2 col-form-label"> Indikator Kinerja: <span
                                            class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" id="indikator" name="indikator" class="form-control"
                                            placeholder="Indikator Kinerja" maxlength="255" required>
                                    </div>
                                </div>
                        </div>
        ...
        $(function() {
            ...
            $('#data_table1').DataTable({
                ...
                "footerCallback": function(row, data, start, end, display) {
                    ...
                    $(api.column(6).footer()).html(numFormat(jumlah5));
                },
            });
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.data) {
                        ...
                        function iformat(icon, container) {
                            ...
                            success: function(response) {
                                ...
                                if (response.success === true) {
                                    ...
                                    Swal.fire({
                                        ...
                                        $('#data_table_modal').DataTable().ajax
                                            .reload(
                                                null,
                                                false)
                                            .draw(false);
                                        $('#data_table2').DataTable().ajax.reload(
                                                null,
                                                false)
                                            .draw(false);
                                        $('#data_table3').DataTable().ajax.reload(
                                                null,
                                                false)
                                            .draw(false);
                                        $("#add-objek-form")[0].reset();
