                        ...
                        <div class="modal-body">
                            <form id="add-form" class="pl-3 pr-3">
                                ...
                                <div class="position-relative form-group">
                                    <label for="namaKomponen"> Nama Komponen: <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" id="namaKomponen" name="namaKomponen" class="form-control"
                                        placeholder="Nama Komponen" maxlength="255" required>
                                </div>
                        </div>
        ...
        function edit(id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#edit-form #namaKomponen").val(response.nama_komponen);
