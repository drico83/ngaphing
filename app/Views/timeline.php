                ...
                <div class="row">
                    <div class="col">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Jadwal Input</li>
                        </ol>
                    </div>
                    <!--end col-->
    ...
    <div class="row">
            ...
            <div class="card mt-2">
                <div class="card-header text-end">
                    <button type="button" class="btn btn-sm btn-soft-primary" onclick="save()" title="Tambah Penyedia">
                        <i class="fas fa-plus me-2"></i> Tambah Jadwal Input</button>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title m-0" id="info-header-modalLabel">Jadwal Input</h6>
                            ...
                            <form id="data-form" class="pl-3 pr-3">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3 row">
                                            <label for="tahun"
                                                class="col-sm-4 form-label align-self-center mb-lg-0">Tahun: <span
                                                    class="text-danger">*</span> </label>
                                            <div class="col-sm-8">
                                                <input type="number" id="tahun" name="tahun" class="form-control"
                                                    placeholder="Tahun" minlength="0" maxlength="4" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="modul"
                                                class="col-sm-4 form-label align-self-center mb-lg-0">Modul: <span
                                                    class="text-danger">*</span> </label>
                                            <div class="col-sm-8">
                                                <input type="text" id="modul" name="modul" class="form-control"
                                                    placeholder="Modul" minlength="0" maxlength="255" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="link"
                                                class="col-sm-4 form-label align-self-center mb-lg-0">Link: <span
                                                    class="text-danger">*</span> </label>
                                            <div class="col-sm-8">
                                                <input type="text" id="link" name="link" class="form-control"
                                                    placeholder="Link" minlength="0" maxlength="255" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="waktu"
                                                class="col-sm-4 form-label align-self-center mb-lg-0">Waktu: <span
                                                    class="text-danger">*</span> </label>
                                            <div class="col-sm-8">
        ...
        function save(id) {
            ...
            if (typeof id === 'undefined' || id < 1) { //add
                ...
                $("#info-header-modalLabel").text('<?= lang("App.add") ?> Jadwal Input');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#info-header-modalLabel").text('<?= lang("App.edit") ?> Jadwal Input');
                        $("#form-btn").text(submitText);
                        $('#data-modal').modal('show');
                        //insert data to form
                        $("#data-form #id").val(response.id);
                        $("#data-form #tahun").val(response.tahun);
                        $("#data-form #modul").val(response.modul);
