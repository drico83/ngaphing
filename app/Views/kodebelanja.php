                ...
                <div class="row">
                    <div class="col">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Kode Belanja</li>
                        </ol>
                    </div>
                    <!--end col-->
                        ...
                        <div class="modal-body">
                            <form id="add-form" class="pl-3 pr-3">
                                ...
                                <div class="position-relative form-group row">
                                    <label for="idKodrek" class="col-sm-3 col-form-label"> Kode Rekening: <span
                                            class="text-danger">*</span> </label>
                                    <div class="col-sm-9">
                                        <select id="idKodrek" name="idKodrek" class="custom-select" required>
                                ...
                                <div class="position-relative form-group row">
                                    <label for="namaBelanja" class="col-sm-3 col-form-label"> Nama Komponen Belanja:
                                        <span class="text-danger">*</span> </label>
                                    <div class="col-sm-9">
                                        <input type="text" id="namaBelanja" name="namaBelanja" class="form-control"
                                            placeholder="Nama Objek Belanja" maxlength="255" required>
                                    </div>
                                </div>

                                <div class="position-relative form-group row">

                                    <label for="satuan" class="col-sm-3 col-form-label"> Satuan: <span
                                            class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-9">
                                        <input type="text" id="satuan" name="satuan" class="form-control"
                                            placeholder="Satuan" maxlength="20" required>
                                    </div>
                                </div>
                                ...
                                <div class="position-relative form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" id="harga" name="harga" class="form-control"
                                            placeholder="Harga" maxlength="11" number="true" required>
                                    </div>
                                </div>
                        </div>
        ...
        function getkodrek() {
            $.ajax({
                ...
                success: function(response) {
                    if (response.data) {
                        $('#add-form #idKodrek').html(response.data);
                        $('#add-form #idKodrek').select2({
        ...
        function edit(id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // $("#edit-form #idKodrek").val(response.id_kodrek);
                    $.ajax({
                        type: "post",
                        url: "<?php echo base_url('kodrek/getkodrek') ?>",
                        data: {
                            kodrek: response.id_kodrek
                        },
                        dataType: "json",
                        success: function(response) {
                            if (response.data) {
                                $('#edit-form #idKodrek').html(response.data);
                                $('#edit-form #idKodrek').select2({
                    ...
                    $("#edit-form #namaBelanja").val(response.nama_belanja);
                    $("#edit-form #satuan").val(response.satuan);
