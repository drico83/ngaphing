...
<div class="container-fluid">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Realisasi DPA</li>
                        </ol>
                    </div>
                    <!--end col-->
    ...
    <div class="row">
            ...
            <div class="card mt-2">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-sm-4">
                            <h5>Cetak Realisasi DPA</h5>
                        </div>
                        <div class="col-sm-8">
                            <form action="<?= base_url() ?>/realisasidpa/cetak" method="post" target="_blank">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <button type="submit" class="btn btn-primary">Cetak Realisasi</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                type: "get",
                url: "<?php echo base_url('cetakrak/getrka') ?>",
                dataType: "json",
                success: function(response) {
                    if (response.data) {
