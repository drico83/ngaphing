                ...
                <div class="row">
                    <div class="col">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Cetak RAB</li>
                        </ol>
                    </div>
                    <!--end col-->
            ...
            <div class="card mt-2">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-sm-3">
                            <h5>Cetak Rencana Anggaran Biaya</h5>
                        </div>
                        <div class="col-sm-9">
                            <form action="<?= base_url() ?>/cetakrabp/cetak" method="post" target="_blank">
                                <div class="row">
                                    ...
                                    <label for="horizontalInput1" class="col-sm-2 form-label align-self-center">Nama
                                        Program</label>
                                    <div class="col-sm-2">
                                        <select id="prog" name="prog" class="custom-select">

                                        </select>
                                    </div>

                                    <div class="col-sm-2">
                                        <button type="submit" class="btn btn-primary">Cetak RAB</button>
                                    </div>
