        ...
        <div class="col-12">
            <div class="card mt-2">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <button type="button" class="btn btn-sm btn-soft-primary text-end" onclick="add()"
                        ...
                        <i class="fas fa-plus me-2"></i> Tambah Program</button>
                        ...
                        <div class="modal-body">
                            <form id="add-form" class="pl-3 pr-3">
                                ...
                                <div class="position-relative form-group">
                                    ...
                                    <input type="text" id="namaProgram" name="namaProgram" class="form-control"
                                        placeholder="Nama Program" maxlength="255" required>
                                </div>
                        </div>
            ...
            <div id="edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Ubah data Program</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true"></span>
                            </button>
                        </div>
        ...
        function edit(id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#edit-form #namaProgram").val(response.nama_program);
