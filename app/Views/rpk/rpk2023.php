                            ...
                            <table id="data_table1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" rowspan="2">Nama UPT</th>
                                        <th class="text-center" rowspan="2">BLUD</th>
                                        <th class="text-center" colspan="7">Anggaran BOK</th>
                                        <th rowspan="2" class="text-center">Status Approved</th>
                                        <th rowspan="2" class="text-center">Aksi</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center">Pagu UKM</th>
                                        <th class="text-center">Usulan UKM</th>
                                        <th class="text-center">Pagu Insentif</th>
                                        <th class="text-center">Usulan Insentif</th>
                                        <th class="text-center">Pagu Manajemen</th>
                                        <th class="text-center">Usulan Manajemen</th>
                                        <th class="text-center">Jumlah BOK</th>
                                    </tr>
                                </thead>
                                <tfoot>
                                    <tr>
        ...
        $(function() {
            $('#data_table1').DataTable({
                ...
                "footerCallback": function(row, data, start, end, display) {
                    ...
                    $(api.column(7).footer()).html(numFormat(jumlah6));
                    $(api.column(8).footer()).html(numFormat(jumlah7));
                    $(api.column(9).footer()).html(numFormat(jumlah8));
                },
            });
