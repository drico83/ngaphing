...
class Raball extends BaseController
{
    ...
    public function tampil()
    {
        ...
        $isitampil .= "<th rowspan='2' style='text-align:center;'>Jumlah RAK</th>";
                ...
                foreach ($komponen as $key => $value) {
                    ...
                    foreach ($result as $row) {
                        ...
                        foreach ($result2 as $key => $value) {
                            ...
                            $isitampil .= "<td></td>";
                            $color = ($value->harga_total > $value->jrak) ? "color:red" : "";
                            $isitampil .= "<td style='text-align:right;" . $color . "'>" . number_format($value->jrak) . "</td>";
                            $isitampil .= "<td><button class='btn btn-primary' onclick='edit(" . $value->id . ")'>Input RAK</button></td>";
                            $isitampil .= "</tr>";
                        };
                    };
                };
