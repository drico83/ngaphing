...
class Drincian extends BaseController
{
    ...
    public function getAll()
    {
        ...
        join rpk on rpk.id=usul_belanja_rpk.id_sub join sub_komponen on sub_komponen.id=rpk.id_menu join rincian on rincian.id=sub_komponen.id_rincian join realisasi ON realisasi.id_rpk=usul_belanja_rpk.id where rpk.status="Approve" AND rincian.id="' . $rincian . '" and usul_belanja_rpk.tahun="' . $tahun . '" group by usul_belanja_rpk.id_pkm) as d';
