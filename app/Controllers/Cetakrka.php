...
class Cetakrka extends BaseController
{
    ...
    public function tampil()
    {
        ...
        $isitampil .= "<tr>";
        $isitampil .= "<td align='center'>RINCIAN BELANJA SUB KEGIATAN<br/>SATUAN KERJA PERANGKAT DAERAH</td>";
        $isitampil .= "</tr>";
        $isitampil .= "<tr>";
