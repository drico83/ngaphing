...
class Cetakraball extends BaseController
{
    ...
    public function tampil()
    {
        ...
        $rinci = $this->usulanrpkModel->select('usul_belanja_rpk.id_pkm,sum(usul_belanja_rpk.harga_total) as harga_total')
            ->where(['usul_belanja_rpk.id_pkm' => $pkm, 'usul_belanja_rpk.tahun' => $tahun])
        ...
        foreach ($rinci as $key => $value) {
            ...
            foreach ($rincian as $key => $value) {
                ...
                $komponen = $this->usulanrpkModel->select('usul_belanja_rpk.id_pkm,sub_komponen.id_kom, komponen.nama_komponen, sum(usul_belanja_rpk.harga_total) as harga_total')
                    ...
                    ->join('rincian', 'rincian.id=sub_komponen.id_rincian')
                    ->where(['usul_belanja_rpk.id_pkm' => $pkm, 'sub_komponen.id_rincian' => $value->id_rincian, 'usul_belanja_rpk.tahun' => $tahun])
