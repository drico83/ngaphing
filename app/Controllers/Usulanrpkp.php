...
class Usulanrpkp extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $result = $this->usulanrpkpModel->select('usul_belanja_rpkp.*, kode_belanja.nama_belanja, kode_belanja.harga, kodrek.kode')
            ->join('kode_belanja', 'kode_belanja.id=usul_belanja_rpkp.id_belanja')
            ->join('kodrek', 'kodrek.id=kode_belanja.id_kodrek')
            ->where([
                'usul_belanja_rpkp.id_pkm' => $idPkm,
                'usul_belanja_rpkp.id_program' => $idProgram,
                'usul_belanja_rpkp.id_sub' => $objek
            ])->findAll();
        $no = 1;
    ...
    public function getOne()
    {
        ...
        if ($this->validation->check($id, 'required|numeric')) {
            ...
            $data = $this->usulanrpkpModel->where('id', $id)->first();
    ...
    public function add()
    {
        ...
        if ($this->validation->run($fields) == FALSE) {
            ...
            if ($this->usulanrpkpModel->insert($fields)) {
    ...
    public function edit()
    {
        ...
        if ($this->validation->run($fields) == FALSE) {
            ...
            if ($this->usulanrpkpModel->update($fields['id'], $fields)) {
    ...
    public function remove()
    {
        ...
        if (!$this->validation->check($id, 'required|numeric')) {
            ...
            if ($this->usulanrpkpModel->where('id', $id)->delete()) {
