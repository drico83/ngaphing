...
class Usulan extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $result = $this->usulanModel->select('usul_belanja.*, kode_belanja.nama_belanja, kode_belanja.harga, kodrek.kode')
            ->join('kode_belanja', 'kode_belanja.id=usul_belanja.id_belanja')
            ->join('kodrek', 'kodrek.id=kode_belanja.id_kodrek')
            ->where([
                'usul_belanja.id_pkm' => $idPkm,
                'usul_belanja.id_program' => $idProgram,
                'usul_belanja.id_sub' => $objek
            ])->findAll();
        $no = 1;
    ...
    public function getOne()
    {
        ...
        if ($this->validation->check($id, 'required|numeric')) {
            ...
            $data = $this->usulanModel->where('id', $id)->first();
    ...
    public function add()
    {
        ...
        if ($this->validation->run($fields) == FALSE) {
            ...
            if ($this->usulanModel->insert($fields)) {
    ...
    public function edit()
    {
        ...
        if ($this->validation->run($fields) == FALSE) {
            ...
            if ($this->usulanModel->update($fields['id'], $fields)) {
    ...
    public function remove()
    {
        ...
        if (!$this->validation->check($id, 'required|numeric')) {
            ...
            if ($this->usulanModel->where('id', $id)->delete()) {
